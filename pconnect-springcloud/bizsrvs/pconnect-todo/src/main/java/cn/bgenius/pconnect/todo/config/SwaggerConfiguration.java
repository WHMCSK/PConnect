package cn.bgenius.pconnect.todo.config;
...
@EnableSwagger2
//@EnableWebMvc //必须存在
//@ComponentScan(basePackages = {"cn.bgenius.pconnect.user.controller"}) //必须存在 扫描的API Controller package name 也可以直接扫描class (basePackageClasses)
